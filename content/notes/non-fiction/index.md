---
title: "Non-Fiction Notes"
description: "Non-fiction Book Notes and Reviews"
cascade:
  showDate: false
---
...
<div style="display:flex; gap:1rem; align-items:flex-start;">
  ...
  <div>
    <h3 class="mb-1">
    <a href="/notes/non-fiction/dopaminenation/" class="hover:underline">
     Dopamine Nation
    </a>
    </h3>
    <div class="text-lg">
...
<div style="display:flex; gap:1rem; align-items:flex-start;">
  ...
  <div>
    <h3 class="mb-1">
    <a href="/notes/non-fiction/therelationshiphandbook/" class="hover:underline">
...
<div style="display:flex; gap:1rem; align-items:flex-start;">
  ...
  <div>
    <h3 class="mb-1">
    <a href="/notes/non-fiction/caffeineblues/" class="hover:underline">
    Caffeine Blues
    </a>
    </h3>
...
<div style="display:flex; gap:1rem; align-items:flex-start;">
  ...
  <div>
    <h3 class="mb-1">
    <a href="/notes/non-fiction/thepsychologyofmoney/" class="hover:underline">
...
<div style="display:flex; gap:1rem; align-items:flex-start;">
  ...
  <div>
    <h3 class="mb-1">
    <a href="/notes/non-fiction/milliondollarweekend/" class="hover:underline">
...
<div style="display:flex; gap:1rem; align-items:flex-start;">
  ...
  <div>
    <h3 class="mb-1">
    <a href="/notes/non-fiction/anythingyouwant/" class="hover:underline">
    Anything You Want
    </a>
    </h3>
    <div class="text-yellow-400 text-lg">
...
<div style="display:flex; gap:1rem; align-items:flex-start;">
  ...
  <div>
    <h3 class="mb-1">
    <a href="/notes/non-fiction/theblogstartup/" class="hover:underline">
     The Blog Startup
    </a>
    </h3>
    <div class="text-lg">
